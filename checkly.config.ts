...
const productionURL = 'https://pixelettetech.com';

const emailChannel = new EmailAlertChannel('email-channel-1', {
  // FIXME: add your own email address, Checkly will send you an email notification if a check fails
  address: 'contact@pixelettetech',
  ...sendDefaults,
});

export const config = defineConfig({
  // FIXME: Add your own project name, logical ID, and repository URL
  projectName: 'Pixelette Tech',
  logicalId: 'Pixelette Tech',
  repoUrl: 'https://github.com/Hamid-Ayub/Pixelette-Tech',
  checks: {
