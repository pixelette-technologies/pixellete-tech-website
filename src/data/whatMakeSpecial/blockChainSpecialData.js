export const blockChainSpecialData = [
  {
    ...
    text: 'Longstanding presence within the UK’s parliamentary technology landscape, including earlier involvement with the APPG on Blockchain. Also working with 7 other governments worldwide',
  },
  {
