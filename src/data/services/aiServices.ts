...
export const aiTechnologies: Technologies = {
  AI_ML_BI: [
    { id: 1, name: 'Python', icon: '/images/sample/python.png' },
    { id: 2, name: 'PyTorch', icon: '/images/sample/python-1.png' },
    { id: 3, name: 'Python', icon: '/images/sample/python-2.png' },
    { id: 4, name: 'TensorFlow', icon: '/images/sample/python-1.png' },
    { id: 5, name: 'Qlik', icon: '/images/tech/mongodb.svg' },
    { id: 6, name: 'Tableau', icon: '/images/sample/python.png' },
    { id: 7, name: 'Qlik', icon: '/images/sample/python.png' },
    { id: 8, name: 'PyTorch', icon: '/images/sample/python-2.png' },
    { id: 9, name: 'TensorFlow', icon: '/images/sample/python-1.png' },
    { id: 10, name: 'Keras', icon: '/images/sample/python-2.png' },
    { id: 11, name: 'Keras', icon: '/images/tech/firebase.svg' },
    { id: 12, name: 'Python', icon: '/images/sample/python-2.png' },
    { id: 13, name: 'Keras', icon: '/images/tech/firebase.svg' },
    { id: 14, name: 'TensorFlow', icon: '/images/tech/flutter.svg' },
    { id: 15, name: 'PyTorch', icon: '/images/sample/python-2.png' },
