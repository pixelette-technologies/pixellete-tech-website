...
export const vrTechnologies: Technologies = {
  'AR/VR Development Platforms & Frameworks': [
    ...
    { id: 7, name: 'Babylon.js', icon: '/images/tech/logos/babylon-js.png' },
    { id: 8, name: 'Three.js', icon: '/images/tech/logos/three-js.png' },
    ...
    { id: 19, name: 'Oculus Integration SDK', icon: '/images/tech/logos/oculus-integration-sdk.png' },
  ...
  'APIs, SDKs & Engines': [
    ...
    { id: 6, name: 'SteamVR SDK', icon: '/images/tech/logos/steamvr-sdk.png' },
    { id: 7, name: 'HTC Vive SDK', icon: '/images/tech/logos/htc-vive-sdk.png' },
    { id: 8, name: 'Leap Motion SDK', icon: '/images/tech/logos/leap-motion-sdk.png' },
    ...
    { id: 11, name: 'Apple SceneKit API', icon: '/images/tech/logos/apple-scenekit-api.png' },
    { id: 12, name: 'Reality Composer API', icon: '/images/tech/logos/reality-composer-api.png' },
    { id: 13, name: 'AR.js', icon: '/images/tech/logos/ar-js.png' },
    ...
    { id: 19, name: 'XR Toolkit API', icon: '/images/tech/logos/xr-toolkit-api.png' },
    ...
    { id: 22, name: 'Azure Spatial Anchors API', icon: '/images/tech/logos/azure-spatial-anchors-api.png' },
  ...
  'Hardware, Cloud & Tools': [
    ...
    { id: 3, name: 'Magic Leap', icon: '/images/tech/logos/magic-leap.png' },
    ...
    { id: 7, name: 'Meta Spark AR Studio', icon: '/images/tech/logos/meta-spark-ar-studio.png' },
    { id: 8, name: 'Adobe Aero', icon: '/images/tech/logos/adobe-aero.png' },
    { id: 9, name: 'Reality Composer', icon: '/images/tech/logos/reality-composer.png' },
    ...
    { id: 15, name: 'Cloudflare XR Services', icon: '/images/tech/logos/cloudflare-xr-services.png' },
    ...
    { id: 22, name: 'Figma for XR Design', icon: '/images/tech/logos/figma-for-xr-design.png' },
    { id: 23, name: 'Jira for AR/VR Project Management', icon: '/images/tech/logos/jira-for-arvr-project-management.png' },
    { id: 24, name: 'Confluence for XR Documentation', icon: '/images/tech/logos/confluence-for-xr-documentation.png' },
  ],
};
