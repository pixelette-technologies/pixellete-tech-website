...
export const vrTechnologies: Technologies = {
  ...
  'Hardware, Cloud & Tools': [
    ...
    { id: 11, name: 'AWS Sumerian Hosting', icon: '/images/tech/logos/amazon-sumerian.png' },
    { id: 12, name: 'Google Cloud for XR', icon: '/images/tech/logos/google-cloud-vision.png' },
