...
export const webDevelopmentTechnologies: Technologies = {
  'Frontend': [
    ...
    { id: 5, name: 'React.js', icon: '/images/tech/logos/react-js.png' },
    { id: 6, name: 'Angular', icon: '/images/tech/logos/angular.png' },
    { id: 7, name: 'Vue.js', icon: '/images/tech/logos/vue-js.png' },
    { id: 8, name: 'Svelte', icon: '/images/tech/logos/svelte.png' },
    { id: 9, name: 'Next.js', icon: '/images/tech/logos/next-js.png' },
    { id: 10, name: 'Nuxt.js', icon: '/images/tech/logos/nuxt-js.png' },
    ...
    { id: 16, name: 'Three.js', icon: '/images/tech/logos/three-js.png' },
    { id: 17, name: 'Babylon.js', icon: '/images/tech/logos/babylon-js.png' },
    { id: 18, name: 'WebGL', icon: '/images/tech/logos/webgl.png' },
    { id: 19, name: 'Chart.js', icon: '/images/tech/logos/chart-js.png' },
    { id: 20, name: 'D3.js', icon: '/images/tech/logos/d3-js.png' },
    { id: 21, name: 'Lit', icon: '/images/tech/logos/lit.png' },
    { id: 22, name: 'Preact', icon: '/images/tech/logos/preact.png' },
    { id: 23, name: 'Stencil.js', icon: '/images/tech/logos/stencil-js.png' },
    { id: 24, name: 'Foundation', icon: '/images/tech/logos/foundation.png' },
  ],
  'Backend': [
    { id: 1, name: 'Node.js', icon: '/images/tech/logos/node-js.png' },
    { id: 2, name: 'Express.js', icon: '/images/tech/logos/express-js.png' },
    ...
    { id: 8, name: 'ASP.NET Core', icon: '/images/tech/logos/asp-net-core.png' },
    { id: 9, name: 'PHP', icon: '/images/tech/logos/php.png' },
    { id: 10, name: 'Java', icon: '/images/tech/logos/java.png' },
    { id: 11, name: 'C#', icon: '/images/tech/logos/c-sharp.png' },
    { id: 12, name: 'Go (Golang)', icon: '/images/tech/logos/go-golang.png' },
    ...
    { id: 16, name: 'Koa.js', icon: '/images/tech/logos/koa-js.png' },
    { id: 17, name: 'Hapi.js', icon: '/images/tech/logos/hapi-js.png' },
    ...
    { id: 22, name: 'Meteor.js', icon: '/images/tech/logos/meteor-js.png' },
  ...
  'Databases, Cloud, & Hosting': [
    ...
    { id: 6, name: 'ElasticSearch', icon: '/images/tech/logos/elasticsearch.png' },
    { id: 7, name: 'Firebase', icon: '/images/tech/logos/firebase.png' },
    ...
    { id: 10, name: 'Microsoft Azure', icon: '/images/tech/logos/microsoft-azure.png' },
  ...
  'DevOps, Testing, & Tools': [
    ...
    { id: 4, name: 'GitLab CI/CD', icon: '/images/tech/logos/gitlab-cicd.png' },
